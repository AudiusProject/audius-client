...
export const remoteConfigStringDefaults: {
  ...
  [StringKeys.COINBASE_PAY_ALLOWED_COUNTRIES]:
    'ALB,AND,AGO,ARG,ARM,AUS,AZE,BHS,BHR,BRB,BEL,BEN,BOL,BWA,BRA,BRN,BGR,BFA,CMR,CHL,COL,CRI,HRV,CYP,CZE,DNK,DOM,ECU,SLV,EST,FIN,FRA,GEO,DEU,GHA,GIB,GRC,GTM,GGY,HND,HKG,HUN,ISL,IOT,IRL,IMN,ITA,JAM,JEY,JOR,KAZ,KEN,KWT,KGZ,LVA,LIE,LTU,LUX,MDV,MLT,MUS,MEX,MCO,MNG,MNE,NAM,NPL,NZL,NIC,NGA,NOR,OMN,PAK,PAN,PRY,PER,PHL,POL,PRT,ROU,RWA,SMR,SRB,SGP,SVK,SVN,ZAF,LKA,SWE,CHE,TWN,TGO,TTO,TUN,TUR,UGA,UKR,ARE,GBR,USA,URY,UZB,VEN,ZMB',
