...
const { getAccountWithPlaylistsAndAlbums } = accountSelectors
...
type AccountData = ReturnType<typeof getAccountWithPlaylistsAndAlbums>
...
function makeMapStateToProps() {
  ...
  const mapStateToProps = (state: AppState) => {
    ...
    const account = getAccountWithPlaylistsAndAlbums(state)
