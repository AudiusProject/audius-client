...
export const MODAL_NAME = 'UploadTrack'

const messages = {
  title: 'Start Uploading',
  description: 'Visit audius.co from a desktop browser',
  bullet1: 'Unlimited Uploads',
  bullet2: 'Crystal Clear 320kbps',
  bullet3: 'Exclusive Conent'
}

const bullets = [messages.bullet1, messages.bullet2, messages.bullet3]
...
export const UploadTrackDrawer = () => {
