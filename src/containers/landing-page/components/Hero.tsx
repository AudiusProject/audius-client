...
import HeroForegroundMobile from 'assets/img/responsive/Hero-Foreground-mobile@2x.png'
...
import GlyphPattern1x from 'assets/img/responsive/glyph-pattern@1x.png'
import GlyphPattern2x from 'assets/img/responsive/glyph-pattern@2x.png'
