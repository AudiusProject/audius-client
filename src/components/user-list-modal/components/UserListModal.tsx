...
import { USER_LIST_TAG as FAVORITES_TAG } from 'common/store/user-list/favorites/sagas'
import { getUserList as favoritesSelector } from 'common/store/user-list/favorites/selectors'
import { USER_LIST_TAG as FOLLOWER_TAG } from 'common/store/user-list/followers/sagas'
import { getUserList as followersSelector } from 'common/store/user-list/followers/selectors'
import { USER_LIST_TAG as FOLLOWING_TAG } from 'common/store/user-list/following/sagas'
import { getUserList as followingSelector } from 'common/store/user-list/following/selectors'
import { USER_LIST_TAG as REPOST_TAG } from 'common/store/user-list/reposts/sagas'
